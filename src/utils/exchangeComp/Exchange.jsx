...
const ReturnExchange = () => {
  ...
  // const handleSubmit = () => {
  //   if (validateForm()) {
  //     returnItems.forEach(({ item, qty, amount_per_item }) => {
  //       const stockItem = filteredStocks.find(
  //         (stock) => stock.description === item
  //       );
  //       if (stockItem) {
  //         updateStock(
  //           stockItem.id,
  //           stockItem.closing_stock + (parseFloat(qty) || 0),
  //           amount_per_item
  //         );
  //       }
  //     });

  //     exchangeItems.forEach(({ item, qty, amount_per_item }) => {
  //       const stockItem = filteredStocks.find(
  //         (stock) => stock.description === item
  //       );
  //       if (stockItem) {
  ...
  //       console.log("Exchange Items:", exchangeItems);
  //     } catch (error) {
  //       console.error("Failed to process returns and exchanges:", error);
  //     }
  //   } else {
  //     console.log("Form validation failed");
  //   }
